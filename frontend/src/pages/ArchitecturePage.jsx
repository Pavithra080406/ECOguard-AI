...
import { Network, Server, Cpu, Database, ShieldCheck, GitBranch, ArrowRight } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="glass-card p-6 rounded-2xl">
        <h1 className="text-xl font-bold text-slate-100 flex items-center space-x-2">
          ...
          <span>ECOguard AI System Architecture & Data Flow</span>
        </h1>
        <p className="text-xs text-slate-400 mt-1">
          Complete production flow from Live/Manual inputs through XGBoost, 28-feature transformation, SHAP XAI, MongoDB persistence, and MLOps monitoring
        </p>
      </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 min-w-[700px] text-xs">
          ...
          <div className="space-y-2 w-44">
            <div className="bg-slate-900 border border-teal-500/40 p-3 rounded-xl text-center">
              ...
              <span className="text-[10px] text-slate-400">City Geocoding & OpenWeather</span>
            </div>
